...
public class Bones {
	...
	public Bones(double userLongitude, double userLatitude,
			double startLongitude, double startLatitude, double userRadius) {
		...
		// these methods must calculate the distance between the internal
		// boundry and the external boundry, respecting whether they are
		// lat/long
		double left = calculateLeftBound(userLongitude, startLongitude,
				userRadius);
		double right = calculateRightBound(userLongitude, startLongitude,
				userRadius);
		double upper = calculateUpperBound(userLatitude, startLatitude,
				userRadius);
		double lower = calculateLowerBound(userLatitude, startLatitude,
				userRadius);
